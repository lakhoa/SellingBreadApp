...
public class ExceptionControllerAdvice {
  ...
  public final ResponseEntity<String> handleInvalidSumToppingQuantityException(
      InvalidSumToppingQuantityException exception) {
    log.error("error: Invalid Sum Topping Quantity Exception");
    return new ResponseEntity<>(exception.getMessage(), HttpStatus.BAD_REQUEST);
  }

  @ExceptionHandler(value = NotFoundOrderException.class)
  public final ResponseEntity<String> handleNotFoundOrderException(
      NotFoundOrderException exception) {
