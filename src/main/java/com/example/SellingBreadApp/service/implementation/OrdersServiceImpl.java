...
public class OrdersServiceImpl implements OrdersService {
  ...
  @Override
  public PageResponseDTO<List<HistoryOrderResponseDTO>> getOrderByDate(Date date,
      Pageable pageable) {
  ...
  @Override
  public PageResponseDTO<List<HistoryOrderResponseDTO>> getOrderByDateBetween(Date dateStart,
